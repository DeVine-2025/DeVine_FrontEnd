...
const LoginRequiredCard = ({
  ...
  return (
    <div className="flex h-[210px] w-[400px] flex-col items-start gap-7 rounded-2xl border border-[var(--ui-200)] bg-[var(--ui-bg)] p-11 text-left shadow-[0_12px_30px_rgba(0,0,0,0.16)]">
