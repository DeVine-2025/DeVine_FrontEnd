  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute right-[24px] top-1/2 flex h-[60px] w-[60px] -translate-y-1/2 items-center justify-center hover:opacity-80"
      >
        <BookmarkFilledIcon aria-hidden className="h-[40px] w-[40px] text-[var(--ui-200)]" />
      </button>
