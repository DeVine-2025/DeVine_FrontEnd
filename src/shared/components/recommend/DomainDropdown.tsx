...
export default function DomainDropdown({
  ...
  return (
    <div
      ref={ref}
      className="animate-dropdown-slide-up absolute top-[calc(100%+12px)] left-0 z-50 w-[380px] overflow-hidden rounded-[12px] border border-[var(--ui-100)] bg-[var(--ui-50)] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.08)]"
    >
